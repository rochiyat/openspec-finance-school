...
## Success Criteria
- [x] An administrator can send a message to all 500+ parents in a single action.
- [x] Users receive the broadcast in their notification center immediately.
- [x] Non-admin roles cannot access the broadcast functionality.
