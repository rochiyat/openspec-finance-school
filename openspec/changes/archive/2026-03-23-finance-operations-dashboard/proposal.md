...
## Success Criteria
- [ ] Finance staff can log in and see a summary dashboard in under 3 seconds.
- [ ] Summary shows total billed, total collected, outstanding receivable, overdue count, unpaid count, and active installment count.
- [ ] Delinquent student list shows each overdue student's NIS, name, and count of overdue billings.
- [ ] Users without `FINANCE` or `SUPERADMIN` role cannot access the endpoint or the page.
- [ ] Unit tests cover the aggregation logic in the service.
