...
## Success Criteria
- [x] Superadmin can access a comprehensive system overview in < 3 seconds.
- [x] All metrics (Users, Finances, Notifications) accurately reflect the total system state.
- [x] Users with `FINANCE`, `GURU`, or `PARENT` roles are strictly prohibited from accessing this view.
- [x] Backend unit tests verify the aggregation of counts and totals across all modules.
